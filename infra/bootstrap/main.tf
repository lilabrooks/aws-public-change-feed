locals {
  ...
  live_control_state_key = "apcf/live-control/terraform.tfstate"
  backend_state_keys     = [local.bootstrap_state_key, local.central_state_key, local.preflight_state_key, local.live_control_state_key]
}
